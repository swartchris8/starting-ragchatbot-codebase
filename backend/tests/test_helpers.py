...
def assert_search_result_format(
    result: str, expected_course: str = None, expected_lesson: int = None
):
...
def check_chroma_db_state(chroma_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            collections_info["course_catalog"] = {"exists": False, "error": str(e)}
        ...
        try:
            ...
            collections_info["course_content"] = {"exists": False, "error": str(e)}
        ...
        return {"chroma_path": chroma_path, "chroma_accessible": False, "error": str(e)}
